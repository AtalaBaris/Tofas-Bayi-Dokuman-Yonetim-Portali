/** Bayi kullanıcı giriş ekranı. */
import { Component, inject, signal } from '@angular/core';
import { AbstractControl, FormBuilder, ReactiveFormsModule, Validators } from '@angular/forms';
import { Router, RouterLink } from '@angular/router';
import { AuthService } from '../../../../../core/services/auth.service';
import { bayiLoginAnimations } from '../../animations/bayi-login.animations';

@Component({
  selector: 'app-bayi-login',
  imports: [ReactiveFormsModule, RouterLink],
  templateUrl: './bayi-login.html',
  styleUrl: '../../styles/bayi-login.scss',
  animations: bayiLoginAnimations,
})
export class BayiLogin {
